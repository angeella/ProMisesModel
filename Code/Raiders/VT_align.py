...
coord =np.load('//dartfs-hpc/rc/home/w/f003vpw/MovieAnalysis/data/coord.npz')["coord"]
#Dk = np.load('//dartfs-hpc/rc/home/w/f003vpw/MovieAnalysis/report_data/dij.npz')['dij']

#load data
with open('//dartfs-hpc/rc/home/w/f003vpw/MovieAnalysis/data/movie.data', 'rb') as movie:  
    # read the data as binary data stream
    dss = pickle.load(movie)
    
with open('//dartfs-hpc/rc/home/w/f003vpw/MovieAnalysis/data/movie32.data', 'rb') as movie32:  
    # read the data as binary data stream
...
np.savez('//dartfs-hpc/rc/home/w/f003vpw/MovieAnalysis/Output/Final_analysis_VT_cv.npz', 
