...
"""
LO Raiders Analysis using nested cross-validation 
"""
...
#Load coordinates
coord =np.load('/Data/Raiders/Raiders_data/coord_LO.npz')["coord"]
#Dk = np.load('//dartfs-hpc/rc/home/w/f003vpw/MovieAnalysis/report_data/dij.npz')['dij']

#Load data
with open('/Data/Raiders/Raiders_data/movie_LO.data', 'rb') as movie:  
    # read the data as binary data stream
    dss = pickle.load(movie)
    
with open('/Data/Raiders/Raiders_data/movie32_LO.data', 'rb') as movie32:  
    # read the data as binary data stream
