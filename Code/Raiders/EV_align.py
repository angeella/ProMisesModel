...
"""
Final analysis EV using nested CV to choose k
"""
...
coord =np.load('//dartfs-hpc/rc/home/w/f003vpw/MovieAnalysis/data/coord_EV.npz')["coord"]
#Dk = np.load('//dartfs-hpc/rc/home/w/f003vpw/MovieAnalysis/report_data/dij.npz')['dij']

#load data
with open('//dartfs-hpc/rc/home/w/f003vpw/MovieAnalysis/data/movie_EV.data', 'rb') as movie:  
    # read the data as binary data stream
    dss = pickle.load(movie)
    
with open('//dartfs-hpc/rc/home/w/f003vpw/MovieAnalysis/data/movie32_EV.data', 'rb') as movie32:  
    # read the data as binary data stream
...
np.savez('//dartfs-hpc/rc/home/w/f003vpw/MovieAnalysis/Output/Final_analysis_EV_cv.npz', 
         errE=errE, errI = errI, an = an, hyp = hyp, gpa = gpa, kval = kval, 
#         errD = errD, 
         kCVE = kCVE, idx1 = idx1, idx2 = idx2, idx3 = idx3,
         kCVI = kCVI, 
#         kCVD = kCVD, 
