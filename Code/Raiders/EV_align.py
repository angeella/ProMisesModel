...
"""
EV Raiders Analysis using nested cross-validation 
"""
...
#Load coordinates
coord =np.load('/Data/Raiders/Raiders_data/coord_EV.npz')["coord"]
#Dk = np.load('//dartfs-hpc/rc/home/w/f003vpw/MovieAnalysis/report_data/dij.npz')['dij']

#Load data
with open('/Data/Raiders/Raiders_data/movie_EV.data', 'rb') as movie:  
    # read the data as binary data stream
    dss = pickle.load(movie)
    
with open('/Data/Raiders/Raiders_data/movie32_EV.data', 'rb') as movie32:  
    # read the data as binary data stream
